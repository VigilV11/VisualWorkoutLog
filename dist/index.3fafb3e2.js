...
const loadMap = async function () {
  ...
  console.log(lat, lng);
  let mapObj = L.map('map').setView([lat, lng], 13);
  // second parameter is the map zoom level
  L.tileLayer(_constantsJs.mapAPIMapbox, _constantsJs.mapAttributionMapbox).addTo(mapObj);
  return mapObj;
};
...
},{"core-js/stable":"1PFvP","regenerator-runtime/runtime":"62Qib","./constants.js":"5vBc0"}],"1PFvP":[function(require,module,exports) {
require('../es');
require('../web');
...
const mapAPIMapbox = 'https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoiYWRhbXppb24iLCJhIjoiY2tsamdudDV5MG10bzJwbm10OW94ZTMxMiJ9.X-ud_zEfQeLpyuZMatrEQQ';
